  ...
  return (
    <html lang="en">
      ...
      <div className="bg-wrapper">
          ...
          <button style={{ background: '#fff', color: '#000', fontSize: '16px', border: 'none', borderRadius: '4px', padding: '16px', fontWeight: 700, marginBottom: '20px' }} onClick={authenticate}>Connect wallet</button>
          {children}
				</main>
				<Footer />
			</div>
