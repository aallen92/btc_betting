  ...
  return(
		<Modal customClass={'play-modal'} show={show} handleModal={handleModal}>
			...
			<div className="modal__btn-wrapper">
				<button disabled={loading} className="btn-secondary" onClick={handleLeather}>
				...
				<button disabled={loading} className="btn-secondary" onClick={handleXverse}>
					<img src="/static/img/xverse-icon.png" alt="xverse-icon" /><span>Xverse</span>
				</button>
				<button disabled={loading} className="btn-secondary" onClick={() => router.push('/flip-coin')}>
